                    ...
                    <tbody>
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('messages.create', ['customerId' => $product->customer_id]) }}">
                                ...
                                <td>
                                    <a href="{{ route('product-manage.edit', $product->id) }}"
                                        class="btn btn-primary btn-sm">Chỉnh sửa</a>
                                    <a href="{{ route('product-variants.list', $product->id) }}"
                                        class="btn btn-warning btn-sm">Mặt hàng</a>
                                    <form action="{{ route('product-manage.destroy', $product->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
