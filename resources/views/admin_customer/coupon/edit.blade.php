                    ...
                    <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                        ...
                        <div class="">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="{{ route('coupons.index') }}">Danh sách mã giảm giá</a></li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="coupon_key" class="form-control" value="{{ $coupon->coupon_key }}" required>
                                        </div>
                                        <div class="mb-3">
